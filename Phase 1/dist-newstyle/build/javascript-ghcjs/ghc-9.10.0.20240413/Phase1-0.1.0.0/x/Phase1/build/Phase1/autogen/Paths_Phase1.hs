...
-- at runtime using the environment variable Phase1_bindir.
...
-- environment variable Phase1_libdir.
...
-- using the environment variable Phase1_dynlibdir.
...
-- runtime using the environment variable Phase1_datadir.
...
-- using the environment variable Phase1_sysconfdir.
...
libdir     = "/home/bomorales/.cabal/lib/javascript-ghcjs-ghc-9.10.0.20240413-inplace/Phase1-0.1.0.0-inplace-Phase1"
dynlibdir  = "/home/bomorales/.cabal/lib/javascript-ghcjs-ghc-9.10.0.20240413-inplace"
datadir    = "/home/bomorales/.cabal/share/javascript-ghcjs-ghc-9.10.0.20240413-inplace/Phase1-0.1.0.0"
libexecdir = "/home/bomorales/.cabal/libexec/javascript-ghcjs-ghc-9.10.0.20240413-inplace/Phase1-0.1.0.0"
sysconfdir = "/home/bomorales/.cabal/etc"

getBinDir     = catchIO (getEnv "Phase1_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "Phase1_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "Phase1_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "Phase1_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "Phase1_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "Phase1_sysconfdir") (\_ -> return sysconfdir)
