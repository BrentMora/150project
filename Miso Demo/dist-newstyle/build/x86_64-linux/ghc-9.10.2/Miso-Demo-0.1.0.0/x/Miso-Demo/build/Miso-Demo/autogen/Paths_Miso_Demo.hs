...
-- at runtime using the environment variable Miso_Demo_bindir.
...
-- environment variable Miso_Demo_libdir.
...
-- using the environment variable Miso_Demo_dynlibdir.
...
-- runtime using the environment variable Miso_Demo_datadir.
...
-- using the environment variable Miso_Demo_sysconfdir.
...
libdir     = "/home/bomorales/.cabal/lib/x86_64-linux-ghc-9.10.2-997f/Miso-Demo-0.1.0.0-inplace-Miso-Demo"
dynlibdir  = "/home/bomorales/.cabal/lib/x86_64-linux-ghc-9.10.2-997f"
datadir    = "/home/bomorales/.cabal/share/x86_64-linux-ghc-9.10.2-997f/Miso-Demo-0.1.0.0"
libexecdir = "/home/bomorales/.cabal/libexec/x86_64-linux-ghc-9.10.2-997f/Miso-Demo-0.1.0.0"
sysconfdir = "/home/bomorales/.cabal/etc"

getBinDir     = catchIO (getEnv "Miso_Demo_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "Miso_Demo_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "Miso_Demo_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "Miso_Demo_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "Miso_Demo_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "Miso_Demo_sysconfdir") (\_ -> return sysconfdir)
